package autoquery;
/* Vient de http://stackoverflow.com/questions/60269/how-to-implement-draggable-tab-using-java-swing */
...
private void convertTab(TabTransferData a_data, int a_targetIndex) {
	    ...
	    // Permet de transférer d'un composant DnDTabbedPane à un autre !
            if (this != source) {
    ...
    /* Version originale mais qui ne conserve pas les TabComponents :
       Lorsqu'on déplace un onglet, la petite coche disparaît.
